...
data:
  ...
  bundledCode: "#line 1 \"Verify/verify-yuki/399.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/399\"\
    ...
    \ in(name)\n#line 6 \"Verify/verify-yuki/399.test.cpp\"\nvoid solve() {\n    LL(N);\n\
    \    Graph gr(N);\n    rep(i, N - 1) {\n        LL(u, v);\n        gr.add_edge(u\
  ...
  requiredBy: []
  timestamp: '2024-05-14 21:57:19+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: Verify/verify-yuki/399.test.cpp
layout: document
redirect_from:
- /verify/Verify/verify-yuki/399.test.cpp
- /verify/Verify/verify-yuki/399.test.cpp.html
