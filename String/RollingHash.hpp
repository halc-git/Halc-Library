...
struct RollingHash{
    ...
    u64 query(const vector<u64> &s,uint32_t lf,uint32_t ri){
    ...
    uint32_t lcp(const vector<u64> &a,uint32_t l1,uint32_t r1,const vector<u64> &b,uint32_t l2,uint32_t r2){
